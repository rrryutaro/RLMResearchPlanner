...
class AppPaths:
    ...
    @property
    def research_dataset(self) -> Path:
        return self.bundled_root / "dataset" / "generated"
    ...
    @property
    def talent_catalog(self) -> Path:
        return self.bundled_root / "data" / "talents" / "catalog.json"
