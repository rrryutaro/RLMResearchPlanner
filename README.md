...
モバイルPWA版v0.0.13では、城と個別施設の建設計画、特殊資材の所持数を反映したジェム目安、研究・建設工程の完了管理、ゲーム表示に合わせた資源短縮、叡智の輪の時間効率に加え、城レベルに連動したギルドヘルプ上限と「開始時」「ヘルプ後」の時間比較を利用できます。月晶工房は建物のマナ強化表と分離し、解放研究として正しい1段階・研究時間・必要資源を表示します。
