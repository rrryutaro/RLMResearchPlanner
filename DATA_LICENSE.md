...
This document applies to the public data files distributed with
`RLMResearchPlanner` and `RLMResearchPlannerPWA`. It does not change the MIT
License that applies to the application source code.

## License boundary

The following files contain research or building data:
...
the Lords Mobile Wiki on Fandom are distributed under the Creative Commons
Attribution-ShareAlike 3.0 Unported license (`CC BY-SA 3.0`). Original project
contributions to the structure, normalization, and arrangement of those
portions are also offered under CC BY-SA 3.0 so that the adapted dataset can be
shared under compatible terms.

In catalog metadata this license is identified as `CC BY-SA 3.0 Unported`.

- License deed: https://creativecommons.org/licenses/by-sa/3.0/
- License legal code: https://creativecommons.org/licenses/by-sa/3.0/legalcode
- Fandom licensing information: https://www.fandom.com/licensing

The MIT License in `LICENSE` applies to application code and project-authored
OCR/configuration data. It must not be interpreted as relicensing Fandom
community content, game trademarks, or material owned by other source sites.

## Changes made to source material

Source information was normalized into project-specific JSON records. The
project adds stable identifiers, multilingual labels, prerequisite references,
level-by-level values, validation metadata, and planner-oriented layout data.
Names and values have also been corrected or cross-checked against the game UI
and the factual references listed below. Article prose, wiki images, videos,
game screenshots, game fonts, audio, and extracted game-client assets are not
redistributed.
...
- Defense: https://lordsmobile.fandom.com/wiki/Defense
- Military: https://lordsmobile.fandom.com/wiki/Military
- Monster Hunt: https://lordsmobile.fandom.com/wiki/Monster_Hunt
- Upgrade Defenses: https://lordsmobile.fandom.com/wiki/Upgrade_Defenses
- Upgrade Military: https://lordsmobile.fandom.com/wiki/Upgrade_Military
- Army Leadership: https://lordsmobile.fandom.com/wiki/Army_Leadership
- Military Command: https://lordsmobile.fandom.com/wiki/Military_Command
...
- Mana Awakening: https://lordsmobile.fandom.com/wiki/Mana_Awakening

## Fandom building attribution

Credit belongs to the contributors of the Lords Mobile Wiki pages below.

- Castle: https://lordsmobile.fandom.com/wiki/Castle
- Castle Wall: https://lordsmobile.fandom.com/wiki/Castle_Wall
- Workshop: https://lordsmobile.fandom.com/wiki/Workshop
- Mine: https://lordsmobile.fandom.com/wiki/Mine
- Vault: https://lordsmobile.fandom.com/wiki/Vault
- Infirmary: https://lordsmobile.fandom.com/wiki/Infirmary
...
values, or availability. No open-content license for these pages is asserted by
this project, and their prose, tables, images, video frames, and audio are not
redistributed.
...
Game names, research names, building names, and trademarks remain the property
of their respective owners. This project is unofficial and is not affiliated
with or endorsed by IGG.
