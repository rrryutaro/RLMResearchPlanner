...
The current public `v0.1.6` release is an alpha version. Its main features are usable, but its features, interface, and bundled data remain under active verification and improvement.
