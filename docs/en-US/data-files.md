...
|---|---|---|
| Backup | Player settings, resources, research and building levels, registered tasks, and paid offers | Replaces the current player data with the backup. Export the current state before restoring another backup. |
...
| Translation file | UI text, research and category names, buildings, effects, and resources | Adds or updates a display language. It does not modify player data. |
