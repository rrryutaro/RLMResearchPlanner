...
export function stateFromBackup(raw) {
  ...
  return sanitizeState({ settings: raw.player.settings, research_levels: raw.player.research_levels, observed_stats: raw.player.settings.observed_stats, updated_at: raw.player.updated_at });
}
