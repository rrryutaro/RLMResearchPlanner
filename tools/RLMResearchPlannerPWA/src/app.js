import { currentEffect, loadCatalog } from "./catalog.js?v=0.1.9-b1";
import { adjustedTime, createPlan, defaultTargetLevel, discountedResearchResourceValue, formatDuration, isInstantNextLevel, isResearchConnectionUnlocked, isTechnolabeRecommended, paginateItems, researchLevelsAfterPlan, shortestAvailable, technolabeUsage } from "./planning.js?v=0.1.9-b1";
import { DEFAULT_FONT_SIZES, FONT_SIZE_MAX, FONT_SIZE_MIN, RESOURCE_KEYS, backupPayload, defaultState, freeSecondsForVip, guildHelpCount, hasSavedState, loadState, maxGuildHelpsForCastle, mergeResearchDirectiveTasks, researchDirectiveFromPayload, researchDirectivePayload, saveState, stateFromBackup } from "./state.js?v=0.1.9-b1";
import { explicitTreeLayout, visibleTreeLayout } from "./tree-layout.js?v=0.1.9-b1";
import { clampTreeZoom, fitTreeZoom } from "./tree-zoom.js?v=0.1.9-b1";
import { formatResourceAmount } from "./resource-format.js?v=0.1.9-b1";
import { CASTLE_RESOURCE_KEYS, buildingLevelsAfterCastleStep, castleProgressLabel, createCastlePlan, loadCastleCatalog, minimumBuildingLevels } from "./castle-planning.js?v=0.1.9-b1";
import { applyDocumentLanguage, installLanguagePack, languagePackTemplate, loadBundledLanguagePacks, loadLanguagePacks, packText, removeLanguagePack, resolveLanguagePack, selectPreferredLocale, translateStatic } from "./language-pack.js?v=0.1.9-b1";
import { PAID_GOALS, PAID_ITEM_KINDS, defaultGemValueEach, defaultPointsEach, emptyPaidOffer, minimumGemsForSpeedupSeconds, paidKindHasTime, paidOfferExchangePayload, paidOffersFromExchangePayload, reorderPaidItems, sanitizePaidOffer, sortedPaidOffers, summarizePaidOffer } from "./paid-value.js?v=0.1.9-b1";
import { SPEEDUP_DURATION_GROUPS, SPEEDUP_DURATION_SECONDS, SPEEDUP_KINDS, addPaidItemsToInventory, normalizeSpeedupInventory, recommendPaidOffers, speedupCoverage, speedupDurationGroup } from "./speedup-inventory.js?v=0.1.9-b1";
import { allocateTalentPlan, expandTalentTargets, loadTalentCatalog, talentDirectiveFromPayload, talentDirectivePayload, talentLayoutColumns, talentPlayerLevelRequirement, talentPointsForPlayerLevel } from "./talent-planning.js?v=0.1.9-b1";

const RELEASE_VERSION = "0.1.9";
const DEVELOPMENT_BUILD = 1;
const ASSET_VERSION = "0.1.9-b1";
