...
const CACHE_NAME = `${CACHE_PREFIX}v0.1.6-b1`;
const APP_SHELL = [
  "./", "./index.html", "./styles.css?v=0.1.6-b1", "./manifest.webmanifest", "./icons/app-icon.svg",
  "./src/app.js?v=0.1.6-b1", "./src/catalog.js?v=0.1.6-b1", "./src/planning.js?v=0.1.6-b1", "./src/castle-planning.js?v=0.1.6-b1", "./src/talent-planning.js?v=0.1.6-b1", "./src/state.js?v=0.1.6-b1", "./src/language-pack.js?v=0.1.6-b1", "./src/paid-value.js?v=0.1.6-b1", "./src/speedup-inventory.js?v=0.1.6-b1", "./src/resource-format.js?v=0.1.6-b1", "./src/tree-layout.js?v=0.1.6-b1", "./src/tree-zoom.js?v=0.1.6-b1",
  "./data/research-dataset/manifest.json?v=0.1.6-b1", "./data/i18n/manifest.json?v=0.1.6-b1",
  "./data/buildings/castle_catalog.json?v=0.1.6-b1", "./data/talents/catalog.json?v=0.1.6-b1",
];

async function manifestAssets() {
  const [researchResponse, localeResponse] = await Promise.all([
    fetch("./data/research-dataset/manifest.json?v=0.1.6-b1", { cache: "reload" }),
    fetch("./data/i18n/manifest.json?v=0.1.6-b1", { cache: "reload" }),
  ]);
  ...
  const versioned = (root, path) => `${root}${path}?v=0.1.6-b1`;
  return [
